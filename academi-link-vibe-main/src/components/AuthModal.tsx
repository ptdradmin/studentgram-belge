...
const AuthModal: React.FC<AuthModalProps> = ({ open, onOpenChange }) => {
    ...
    try {
      ...
      if (data.user) {
        const profileData = {
          ...
          class_year: signUpData.classYear,
          student_id: signUpData.studentId,
          is_minor: signUpData.isMinor,
          parent_email: signUpData.parentEmail,
          is_verified: false,
          verification_status: 'pending',
          account_private: signUpData.isMinor,
          allow_messages: !signUpData.isMinor,
          show_email: false,
          bio: '',
          avatar_url: null,
          cover_url: null,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md mx-auto max-h-[90vh] overflow-y-auto bg-gradient-to-br from-pink-50 to-orange-50 border-0 shadow-2xl" aria-describedby="auth-description">
        <DialogHeader className="text-center space-y-4 pb-6">
          ...
          <div>
            ...
            <p id="auth-description" className="text-gray-600 mt-2">
