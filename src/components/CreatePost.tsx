  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const postData = {
        ...
        tags,
        isPublic,
        relatedCourse: relatedCourse.trim() || null,
        academicLevel: currentUser.level,
        likesCount: 0,
        commentsCount: 0,
        sharesCount: 0,
        isModerated: false,
        moderationStatus: currentUser.isMinor ? 'pending' : 'approved' as 'approved' | 'pending' | 'rejected'
      };
